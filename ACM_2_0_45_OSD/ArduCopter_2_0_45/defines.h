...
#define GPS_PROTOCOL_UBLOX_DL	8 //mjc for Ublox_DL with DOP message

// OSD protocol codes
#define OSD_PROTOCOL_DISABLED          0 //mjc
#define OSD_PROTOCOL_REMZIBI           1 //mjc
#define OSD_PROTOCOL_EAGLETREE_PRO     2 //mjc
// 
#define CALLSIGN_DISABLED	0
#define CALLSIGN_ENABLED	1
#define CALLSIGN_TEXT	  	"" //null string
...
#define MSG_GPS_LOCK 0x0e //mjc GPS_LOCK for UBLOX_DL my old MavLk ID now 0x65
...
//#define MSG_GPS_LOCK 0x65 //mjc GPS_LOCK for UBLOX_DL
