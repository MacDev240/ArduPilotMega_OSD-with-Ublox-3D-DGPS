...
camera_stabilization()
{
	...
	g.rc_camera_pitch.servo_out = g.rc_camera_pitch.control_mix(-dcm.pitch_sensor); // '-' to reverse mjc
	// limit
	...
	*/
	...
	// allow control mixing
	//
	//g.rc_camera_roll.set_pwm(APM_RC.InputCh(CH_4)); // I'm using CH 4 Rudder input here.
	g.rc_camera_roll.set_pwm(APM_RC.InputCh(CH_5)); // I'm using CH 5  Gear with pitch input here.
